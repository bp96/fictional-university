        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            <ul>
              ...
              <!-- first php part in if statement makes the link in menu bar appear yellow when clicked on -->
              <li <?php if(get_post_type()=='program') echo 'class="current-menu-item"'  ?>><a href="<?php echo get_post_type_archive_link('program'); ?>">Program</a></li>
          ...
          <div class="site-header__util">
            <?php 
             ...
             <a href="<?php echo esc_url(site_url('/my-notes')); ?>" class="btn btn--small btn--orange float-left push-right">My Notes</a>
              ...
              <span class="site-header__avatar"><?php echo get_avatar(get_current_user_id(), 60) // profile pic is 60px ?></span> 
